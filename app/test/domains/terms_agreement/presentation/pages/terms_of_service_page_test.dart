...
void main() {
  group('TermsOfServicePage', () {
    ...
    Widget createTestWidget() {
      return MaterialApp(home: const TermsOfServicePage());
    }
    ...
    group('AppBar 테스트', () {
      ...
      testWidgets('AppBar 제목이 "이용약관"이어야 한다', (WidgetTester tester) async {
        // Given & When
        await tester.pumpWidget(createTestWidget());
      ...
      testWidgets('AppTypography.head3 스타일이 적용되어야 한다', (
        ...
        // Then
        final titleText = tester.widget<Text>(find.text('이용약관'));
    ...
    group('Body 테스트', () {
      ...
      testWidgets('Padding 위젯이 렌더링되어야 한다', (WidgetTester tester) async {
        ...
        WidgetVerifiers.verifyWidgetRenders(
          tester: tester,
          widgetType: Padding,
          expectedCount: 2, // MaterialApp과 TermsOfServicePage에서 각각 Padding이 있음
        );
      });
