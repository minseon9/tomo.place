...
class TermsOfServicePage extends StatelessWidget {
  ...
  static const Map<String, String> _termsContents = {
    "제1조 (목적)":
        "본 약관은 tomo place가 제공하는 서비스(이하 \"서비스\")의 이용 조건 및 절차, 회사와 회원 간의 권리·의무 및 책임 사항, 기타 필요한 사항을 규정함을 목적으로 합니다.",
    "제2조 (회원의 의무)":
